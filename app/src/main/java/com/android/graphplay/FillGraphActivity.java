...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nestedList1.add(new FillGraph.GraphValue(300.0f, 300,graphColor2));
        nestedList1.add(new FillGraph.GraphValue(440.0f, 350,graphColor2));
        nestedList1.add(new FillGraph.GraphValue(590.0f, 400,graphColor2));
